...
public class Test10Logout extends Test00Base {
    ...
    @Feature("Valid Tests")
    @Feature("USER 1")
    @Story("Logout Check With a Feature")
    ...
    public void testLogoutCheckWishList() throws IOException {
        ...
        takeScreenShot("Wishlist opened with logged in account");
        ...
        driver.findElement(By.linkText("Wishlist")).click();
        takeScreenShot("Wishlist opened with logged out account");
